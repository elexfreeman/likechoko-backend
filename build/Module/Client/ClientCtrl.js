 ...
 * insert
 */
router.post(ClientR_1.ClientR.insert.route, async (req, res) => {
 ...
 * update
 */
router.post(ClientR_1.ClientR.update.route, async (req, res) => {
    const ctrl = new ClientController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ClientR_1.ClientR.getById.route, async (req, res) => {
    const ctrl = new ClientController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(ClientR_1.ClientR.list.route, async (req, res) => {
    const ctrl = new ClientController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(ClientR_1.ClientR.listInfo.route, async (req, res) => {
    const ctrl = new ClientController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * Client column
 */
router.post(ClientR_1.ClientR.info.route, async (req, res) => {
    const ctrl = new ClientController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
