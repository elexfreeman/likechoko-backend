...
exports.InventoryM = void 0;
const System = __importStar(require("@a-a-game-studio/aa-core/lib/Namespace/System"));
// Системные классы
// Классы SQL Запросов
const InventorySQL_1 = require("./InventorySQL");
// Валидация
const V = __importStar(require("./InventoryV"));
 ...
 * Категории товаров
 */
class InventoryM extends System.BaseM {
    constructor(req) {
        super(req);
        this.inventorySQL = new InventorySQL_1.InventorySQL(req);
    }
    ...
    async faList(data) {
        ...
        let nTotal = 0;
        if (ok) {
            aList = await this.inventorySQL.faList(new SearchS_1.SearchS().fSetParam(data));
            nTotal = await this.inventorySQL.faListTotal(new SearchS_1.SearchS().fSetParam(data));
        }
        let out = null;
        if (ok) {
            // Формирование ответа
...
exports.InventoryM = InventoryM;
//# sourceMappingURL=InventoryM.js.map