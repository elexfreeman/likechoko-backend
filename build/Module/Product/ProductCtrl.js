 ...
 * insert
 */
router.post(ProductR_1.ProductR.insert.route, async (req, res) => {
 ...
 * update
 */
router.post(ProductR_1.ProductR.update.route, async (req, res) => {
    const ctrl = new ProductController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ProductR_1.ProductR.getById.route, async (req, res) => {
    const ctrl = new ProductController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(ProductR_1.ProductR.list.route, async (req, res) => {
    const ctrl = new ProductController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(ProductR_1.ProductR.listInfo.route, async (req, res) => {
    const ctrl = new ProductController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * Product column
 */
router.post(ProductR_1.ProductR.info.route, async (req, res) => {
    const ctrl = new ProductController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
