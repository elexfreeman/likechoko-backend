 ...
 * insert
 */
router.post(ProductCategoryR_1.ProductCategoryR.insert.route, async (req, res) => {
 ...
 * update
 */
router.post(ProductCategoryR_1.ProductCategoryR.update.route, async (req, res) => {
    const ctrl = new ProductCategoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ProductCategoryR_1.ProductCategoryR.getById.route, async (req, res) => {
    const ctrl = new ProductCategoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(ProductCategoryR_1.ProductCategoryR.list.route, async (req, res) => {
    const ctrl = new ProductCategoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(ProductCategoryR_1.ProductCategoryR.listInfo.route, async (req, res) => {
    const ctrl = new ProductCategoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 */
router.post(ProductCategoryR_1.ProductCategoryR.info.route, async (req, res) => {
    const ctrl = new ProductCategoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
