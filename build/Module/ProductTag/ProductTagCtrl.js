 ...
 * List
 */
router.post(ProductTagR_1.ProductTagR.list.route, async (req, res) => {
 ...
 * insert
 */
router.post(ProductTagR_1.ProductTagR.insert.route, async (req, res) => {
    const ctrl = new ProductTagController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * update
 */
router.post(ProductTagR_1.ProductTagR.update.route, async (req, res) => {
    const ctrl = new ProductTagController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ProductTagR_1.ProductTagR.getById.route, async (req, res) => {
    const ctrl = new ProductTagController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
