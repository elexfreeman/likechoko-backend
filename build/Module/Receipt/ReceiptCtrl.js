 ...
 */
router.get(Router_1.ReceiptR.sUrl, 
// eslint-disable-next-line
(0, ResponseSys_1.faResponseStatic)(Router_1.ReceiptR.sTpl, MainRequest_1.TError.PageNotFound, async (req, res, error) => {
    return {};
}));
