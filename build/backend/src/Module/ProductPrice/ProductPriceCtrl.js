 ...
 * insert
 */
router.post(ProductPriceR_1.ProductPriceR.insert.route, async (req, res, next) => {
 ...
 * update
 */
router.post(ProductPriceR_1.ProductPriceR.update.route, async (req, res, next) => {
  const ctrl = new ProductPriceController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ProductPriceR_1.ProductPriceR.getById.route, async (req, res, next) => {
  const ctrl = new ProductPriceController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(ProductPriceR_1.ProductPriceR.list.route, async (req, res, next) => {
  const ctrl = new ProductPriceController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(ProductPriceR_1.ProductPriceR.listInfo.route, async (req, res, next) => {
  const ctrl = new ProductPriceController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * ProductPrice column
 */
router.post(ProductPriceR_1.ProductPriceR.info.route, async (req, res, next) => {
  const ctrl = new ProductPriceController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
