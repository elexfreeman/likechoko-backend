 ...
 * insert
 */
router.post(StorehouseR_1.StorehouseR.insert.route, async (req, res, next) => {
 ...
 * update
 */
router.post(StorehouseR_1.StorehouseR.update.route, async (req, res, next) => {
  const ctrl = new StorehouseController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(StorehouseR_1.StorehouseR.getById.route, async (req, res, next) => {
  const ctrl = new StorehouseController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(StorehouseR_1.StorehouseR.list.route, async (req, res, next) => {
  const ctrl = new StorehouseController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(StorehouseR_1.StorehouseR.listInfo.route, async (req, res, next) => {
  const ctrl = new StorehouseController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * Storehouse column
 */
router.post(StorehouseR_1.StorehouseR.info.route, async (req, res, next) => {
  const ctrl = new StorehouseController(req, res);
  await ctrl.faInit();
  await ctrl.userSys.isAuth(); // Пробуем авторизироваться
