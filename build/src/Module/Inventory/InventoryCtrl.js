 ...
 * insert
 */
router.post(InventoryR_1.InventoryR.insert.route, async (req, res) => {
 ...
 * update
 */
router.post(InventoryR_1.InventoryR.update.route, async (req, res) => {
    const ctrl = new InventoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(InventoryR_1.InventoryR.getById.route, async (req, res) => {
    const ctrl = new InventoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List
 */
router.post(InventoryR_1.InventoryR.list.route, async (req, res) => {
    const ctrl = new InventoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * List info
 */
router.post(InventoryR_1.InventoryR.listInfo.route, async (req, res) => {
    const ctrl = new InventoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * Inventory column
 */
router.post(InventoryR_1.InventoryR.info.route, async (req, res) => {
    const ctrl = new InventoryController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
