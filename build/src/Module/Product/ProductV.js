...
exports.delTag = exports.addTag = exports.insert = exports.getById = exports.update = exports.list = void 0;
...
function update(req, data) {
    ...
    rules.set(rules.rule('category_id').type(Components.ModelRulesT.int).moreOrEq(0).errorEx('category_id', 'category_id'));
    // ---------------------------------------
    let validator = new Components.ModelValidatorSys(req.sys.errorSys);
    validator.fValid(rules.get(), data);
    return validator.getResult();
