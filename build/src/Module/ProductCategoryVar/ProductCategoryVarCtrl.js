 ...
 * List
 */
router.post(ProductCategoryVarR_1.ProductCategoryVarR.list.route, async (req, res) => {
 ...
 * insert
 */
router.post(ProductCategoryVarR_1.ProductCategoryVarR.insert.route, async (req, res) => {
    const ctrl = new ProductCategoryVarController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * update
 */
router.post(ProductCategoryVarR_1.ProductCategoryVarR.update.route, async (req, res) => {
    const ctrl = new ProductCategoryVarController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
 ...
 * get by id
 */
router.post(ProductCategoryVarR_1.ProductCategoryVarR.getById.route, async (req, res) => {
    const ctrl = new ProductCategoryVarController(req, res);
    await ctrl.faInit();
    await ctrl.userSys.isAuth(); // Пробуем авторизироваться
